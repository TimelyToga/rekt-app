package com.timothyblumberg.fun.rekt.ShakeDector;
...
public class ShakeDetector implements SensorEventListener {
    ...
    ArrayList<ShakeDetectorListener> listeners;
    ...
    public ShakeDetector(Context context) {
        ...
        listeners = new ArrayList<ShakeDetectorListener>();
    }
    ...
    private static final int SHAKE_CHECK_THRESHOLD = 400;

    /**
     * After we detect a shake, we ignore any events for a bit of time. We don't want two shakes to close together.
     */
    private static final int IGNORE_EVENTS_AFTER_SHAKE = 2000;
